...
class SQLClauseSanitiser {
    ...
    private $whitelistedFunctions = [
        ...
        "PERCENT" => ["params" => ["X", "..."], "category" => self::NUMERIC_WHITELISTED_FUNCTION,
            "description" => "Returns the percentage of X of the sum of all values of X.  If other column names are supplied as additional arguments
            these are used to partition the percentage to unique values of the supplied columns."],
        ...
        "MINIMUM" => ["params" => ["X", "..."], "category" => self::NUMERIC_WHITELISTED_FUNCTION,
            "description" => "Returns the minimum of values of X in the dataset. Later arguments are columns to be partitioned over."],
        "AVERAGE" => ["params" => ["X", "..."], "category" => self::NUMERIC_WHITELISTED_FUNCTION,
        ...
        "TOTAL" => ["params" => ["X", "..."], "category" => self::NUMERIC_WHITELISTED_FUNCTION,
            "description" => "Returns the sum of all values for X for the whole dataset.  If other column names are supplied as additional arguments
            these are used to partition the total to unique values of the supplied columns."],
