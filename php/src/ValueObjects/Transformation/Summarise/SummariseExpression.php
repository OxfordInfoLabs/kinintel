...
class SummariseExpression {
    ...
    const EXPRESSION_TYPE_COUNT_TOTAL = "COUNT_TOTAL";
    const EXPRESSION_TYPE_COUNT_PERCENT = "COUNT_PERCENT";
    const EXPRESSION_TYPE_SUM = "SUM";
    const EXPRESSION_TYPE_SUM_TOTAL = "SUM_TOTAL";
    const EXPRESSION_TYPE_SUM_PERCENT = "SUM_PERCENT";
